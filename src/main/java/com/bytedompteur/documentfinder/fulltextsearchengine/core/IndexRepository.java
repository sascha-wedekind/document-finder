...
public class IndexRepository {
    ...
    public static final String PAYLOAD_FIELD_NAME_GERMAN = "payload_german";
    public static final String PAYLOAD_FIELD_NAME_ENGLISH = "payload_english";
    ...
    public static final Pattern NUMERIC = Pattern.compile("^[0-9]{1}[0-9,.]*$");
    ...
    public void save(FileRecord value) throws IOException {
        ...
        TextField payloadFieldGerman;
        TextField payloadFieldEnglish;
        if (locale.equals(Locale.GERMAN)) {
            payloadFieldGerman = new TextField(PAYLOAD_FIELD_NAME_GERMAN, value.payloadReader());
            payloadFieldEnglish = new TextField(PAYLOAD_FIELD_NAME_ENGLISH, StringReader.nullReader());
        } else {
            payloadFieldGerman = new TextField(PAYLOAD_FIELD_NAME_GERMAN, StringReader.nullReader());
            payloadFieldEnglish = new TextField(PAYLOAD_FIELD_NAME_ENGLISH, value.payloadReader());
        }
        ...
        document.add(payloadFieldGerman);
        document.add(payloadFieldEnglish);
